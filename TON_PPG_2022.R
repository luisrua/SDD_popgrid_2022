# POPULATION GRID NAURU - TON - 2022 UPDATE
...
census_year <- 2021
current_year <- 2022
pop_2021 <- 100179  # calculated from latest census data
prjpop_2022 <- 99283  # From SDD .STAT population projections
...
pts <- st_read(paste0(dd,"/layers/TON_hhlocPHC2021.gpkg"))
