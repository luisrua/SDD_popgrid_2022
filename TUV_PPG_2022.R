# POPULATION GRID Tuvalu - TUV - 2022 UPDATE
...
census_year <- 2017
current_year <- 2022
pop_2017 <- 10645  # calculated from latest census data
prjpop_2022 <-  10778 
# From SDD .STAT population projections
...
pts <- st_read(paste0(dd,"/layers/2017PHC_HHloc_Census.shp"))
pts$pop <- pts$hhsize_int
...
rastpop2017_100m <- rasterize(pts,rast100m,'pop',fun=sum)
rastpop2017_100m
