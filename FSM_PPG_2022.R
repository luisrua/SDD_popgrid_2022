# POPULATION GRID Federated States of Micronesia - FSM - 2022 UPDATE
...
prjpop_2022 <- 105987  # From SDD .STAT population projections
...
pts <- st_read(paste0(dd,"/layers/FSM_GPSHH_AHS_2010_4326.shp"))
pts$pop <- pts$ahs2010
